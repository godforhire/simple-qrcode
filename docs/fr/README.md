...
###### Laravel <= 5.4
Ajouter l'entrée `godforhire\QrCode\QrCodeServiceProvider::class` au tableau `providers` du fichier de configuration `config/app.php`.

#### Alias

###### Laravel <= 5.4
Enfin, ajoutez l'entrée `'QrCode' => godforhire\QrCode\Facades\QrCode::class` au tableau `aliases` du fichier de configuration `config/app.php`.
...
![Fusion de Logo](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/merged-qrcode.png?raw=true)
