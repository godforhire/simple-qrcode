...
###### Laravel <= 5.4
Registrate `godforhire\QrCode\QrCodeServiceProvider::class` nel vostro `config/app.php` all'interno dell'array `providers`.

#### Alias

###### Laravel <= 5.4
Infine, registrate `'QrCode' => godforhire\QrCode\Facades\QrCode::class` nel vostro file di configurazione `config/app.php` all'interno dell'array `aliases`.
