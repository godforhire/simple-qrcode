[![构建状态](https://travis-ci.org/godforhire/simple-qrcode.svg?branch=master)](https://travis-ci.org/godforhire/simple-qrcode) [![最新稳定版本](https://poser.pugx.org/godforhire/simple-qrcode/v/stable.svg)](https://packagist.org/packages/godforhire/simple-qrcode) [![最新版本](https://poser.pugx.org/godforhire/simple-qrcode/v/unstable.svg)](https://packagist.org/packages/godforhire/simple-qrcode) [![许可](https://poser.pugx.org/godforhire/simple-qrcode/license.svg)](https://packagist.org/packages/godforhire/simple-qrcode) [![下载量](https://poser.pugx.org/godforhire/simple-qrcode/downloads.svg)](https://packagist.org/packages/godforhire/simple-qrcode)
...
使用 `composer require godforhire/simple-qrcode "~3"` 安装软件包，
...
###### Laravel <= 5.4
注册 `godforhire\QrCode\QrCodeServiceProvider::class` 至 `config/app.php` 的 `providers` 数组里.

#### 添加 Aliases

###### Laravel <= 5.4
最后,注册 `'QrCode' => godforhire\QrCode\Facades\QrCode::class` 至 `config/app.php` 的 `aliases` 数组里.
...
![200 像素](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/200-pixels.png?raw=true) ![250 像素](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/250-pixels.png?raw=true)
...
![红色二维码](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-qrcode.png?raw=true) ![红色透明二维码](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-25-transparent.png?raw=true)
...
![红色背景二维码](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-background.png?raw=true) ![红色透明背景二维码](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-25-transparent-background.png?raw=true)
...
| 类型 | 范例 |
| --- | --- |
| `vertical`垂直 | ![垂直](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/vertical.png?raw=true) |
| `horizontal`水平 | ![水平](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/horizontal.png?raw=true) |
| `diagonal`对角 | ![对角](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/diagonal.png?raw=true) |
| `inverse_diagonal`反对角 | ![反对角](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/inverse_diagonal.png?raw=true) |
| `radial`迳向 | ![迳向](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/radial.png?raw=true) |
...
| 风格 | 范例 |
| --- | --- |
| `sqaure`方 | ![方](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/200-pixels.png?raw=true) |
| `dot`点 | ![点](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/dot.png)|
| `round`圆 | ![圆](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/round.png?raw=true) |
...
| --- | --- |
| `sqaure`方 | ![方](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/200-pixels.png?raw=true) |
| `circle`圆 | ![圆](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/circle-eye.png?raw=true)|
...
![合并Logo](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/merged-qrcode.png?raw=true)
...
你还可以在Laravel框架之外调用,只需要实例化 `BaconQrCodeGenerator` 类.
	...
	use godforhire\QrCode\BaconQrCodeGenerator;
