...
> 詳細は https://github.com/godforhire/simple-qrcode/issues/205 を参照してください。
...
`composer require godforhire/simple-qrcode "~4"` を実行してパッケージを追加します。
...
![QRコード生成例](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/make-me-into-a-qrcode.png?raw=true)
...
![赤が背景色のQRコード](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-background.png?raw=true) ![赤が背景色で透過なQRコード](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-25-transparent-background.png?raw=true)
...
| タイプ                | 例                                                                                                                                    |
|--------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| `vertical`         | ![Vertical](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/vertical.png?raw=true)                 |
...
| `inverse_diagonal` | ![Inverse Diagonal](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/inverse_diagonal.png?raw=true) |
...
![ロゴを重ねた状態のサンプル](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/merged-qrcode.png?raw=true)
