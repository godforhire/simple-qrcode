...
> There was a mistake when creating 4.1.0 and allowing a backwards breaking change into the master branch.  The `generate` method will now return an instance of `Illuminate\Support\HtmlString` if you are running Laravel.  See https://github.com/godforhire/simple-qrcode/issues/205 for more information.
...
Run `composer require godforhire/simple-qrcode "~4"` to add the package. 
...
![Example QrCode](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/make-me-into-a-qrcode.png?raw=true)
