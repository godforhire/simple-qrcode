[![Build Status](https://travis-ci.org/godforhire/simple-qrcode.svg?branch=master)](https://travis-ci.org/godforhire/simple-qrcode) [![Latest Stable Version](https://poser.pugx.org/godforhire/simple-qrcode/v/stable.svg)](https://packagist.org/packages/godforhire/simple-qrcode) [![Latest Unstable Version](https://poser.pugx.org/godforhire/simple-qrcode/v/unstable.svg)](https://packagist.org/packages/godforhire/simple-qrcode) [![License](https://poser.pugx.org/godforhire/simple-qrcode/license.svg)](https://packagist.org/packages/godforhire/simple-qrcode) [![Total Downloads](https://poser.pugx.org/godforhire/simple-qrcode/downloads.svg)](https://packagist.org/packages/godforhire/simple-qrcode)
...
![Example 1](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/example-1.png?raw=true) ![Example 2](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/example-2.png?raw=true)

<a id="docs-upgrade"></a>
## Upgrade-Anleitung

Um von v2 auf v3 zu aktualisieren, muss die Versionsangabe der `godforhire/simple-qrcode` Abhängigkeit in der `composer.json` Datei auf `~4` geändert werden:

	"require": {
		"godforhire/simple-qrcode": "~4"
	}
  
Ein abschließender Aufruf von `composer update godforhire/simple-qrcode` aktualisiert das installierte Paket.

>Um das `png` Bildformat zu verwenden, **muss zwingend** die `imagick` PHP Extension installiert werden. 

#### v4

> In Version 4.1.0 hat sich ein Breaking Change eingeschlichen, der die Abwärtskompatibilität beeinträchtigt. Die `generate` Methode liefert in Laravel statt eines Strings nun eine `Illuminate\Support\HtmlString` Instanz zurück. Weitere Informationen dazu unter https://github.com/godforhire/simple-qrcode/issues/205.
...
```
use godforhire\QrCode\Facades\QrCode;
```
...
Das Paket kann durch Ausführung von `composer require godforhire/simple-qrcode "~4"` installiert werden. 
...
![200 Pixels](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/200-pixels.png?raw=true) ![250 Pixels](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/250-pixels.png?raw=true) 
...
![Red QrCode](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-qrcode.png?raw=true) ![Red Transparent QrCode](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-25-transparent.png?raw=true)
...
![Red Background QrCode](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-background.png?raw=true) ![Red Transparent Background QrCode](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/red-25-transparent-background.png?raw=true)
...
| Typ | Beispiel |
| --- | --- |
| `vertical` | ![Veritcal](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/vertical.png?raw=true) |
| `horizontal` | ![Horizontal](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/horizontal.png?raw=true) |
| `diagonal` | ![Diagonal](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/diagonal.png?raw=true) |
| `inverse_diagonal` | ![Invrse Diagonal](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/inverse_diagonal.png?raw=true) |
| `radial` | ![Radial](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/radial.png?raw=true) |
...
| Auge Nr. | Beispiel |
| --- | --- |
| `0` | ![Eye 0](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/eye-0.png?raw=true) |
| `1` | ![Eye 1](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/eye-1.png?raw=true)|
| `2` | ![Eye  2](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/eye-2.png?raw=true) |
...
| Stil | Beispiel |
| --- | --- |
| `square` | ![Square](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/200-pixels.png?raw=true) |
| `dot` | ![Dot](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/dot.png)|
| `round` | ![Round](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/round.png?raw=true) |
...
| --- | --- |
| `square` | ![Square](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/200-pixels.png?raw=true) |
| `circle` | ![Circle](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/circle-eye.png?raw=true)|
...
![Merged Logo](https://raw.githubusercontent.com/godforhire/simple-qrcode/master/docs/imgs/merged-qrcode.png?raw=true)
...
Dieses Paket kann auch ohne Laravel verwendet werden, indem man eine neue Instanz der `Generator` Klasse erzeugt.
	...
	use godforhire\QrCode\Generator;
