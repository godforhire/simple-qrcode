...
###### Laravel <= 5.4
config/app.php में providers array में godforhire\QrCode\QrCodeServiceProvider::class को रजिस्टर करें।

#### Aliases (उपनाम)

###### Laravel <= 5.4
आखिर में 'QrCode' => godforhire\QrCode\Facades\QrCode::class को config/app.php विन्यास फ़ाइल में aliases array में रजिस्टर करें।
