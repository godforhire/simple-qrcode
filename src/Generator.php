...
use godforhire\QrCode\DataTypes\DataTypeInterface;
...
class Generator
{
     ...
     * @param godforhire\QrCode\boolean|bool $absolute
     * @return Generator
     */
    ...
    protected function formatClass(string $method): string
    {
        ...
        $class = "godforhire\QrCode\DataTypes\\".$method;
